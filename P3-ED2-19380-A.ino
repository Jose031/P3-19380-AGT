...
void loop()
{
  leerSensor(); // Llamado de función para que el sensor este leyendo el valor BPM y SPO2  todo el tiempo en el ESP32.
  BPMYSPO2(); //Llamdo de función encargada de mandar el ultimo dato leído por el ESP32 a la Tiva C.
}
//**********************************************************************************************************************
// Fuinciones
//**********************************************************************************************************************
